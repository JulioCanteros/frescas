    ...
    public partial class Form1 : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    lblNyA.Text = txtApellido.Text + " " + txtNombre.Text;
                    MessageBox.Show(lblNyA.Text + " " + "agregado correctamente", "Nuevo Cliente", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult ask = MessageBox.Show("Esta seguro que desea eliminar al cliente" + " " + lblNyA.Text + "  ?", "Atencion", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                if (ask == DialogResult.Yes)
                {
                    txtDni.Clear();
                    txtApellido.Clear();
